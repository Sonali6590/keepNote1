...
public class NoteController {
	...
	NoteRepository noteRepo = (NoteRepository) ctx.getBean("noteRepository");
	 ...
	 * Please note that the createdAt field should lways be auto populated with
	...
	// public String addNote(ModelMap maps) {
	// noteRepo.addNote(note);
	// maps.addAttribute(noteRepo.getAllNotes());
	// return "index";
	//
